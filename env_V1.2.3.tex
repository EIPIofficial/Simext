...
\setuphead[title][header=high,align=middle,textstyle=\TitleFont]

\definehead[author][title][header=high,align=middle,textstyle=\tfb]
...
\defineenumeration[structure][title=yes,prefix=yes,
prefixsegments=chapter:section,way=bysection]
...
\defineenumeration[property][number=yes,title=yes,text={Property}]

\setupexternalfigures[location=global, directory={images}]
...
\setupbodyfont[10pt,libertinus]

\definefont[TitleFont][name:dejavu*italic at 50pt]

  
%%%%%%%%%%%% Composing %%%%%%%%%%%%%

\setupenumeration[headcommand=\groupedcommand{}{.},alternative=serried,indenting=yes,width=fit,way=bysection]
...
\setupmathfence[alternative=small]
...
\definemathfunction[Nat]
\definemathfunction[Bimod]
\definemathfunction[Sing]
\definemathfunction[Rad]
\definemathfunction[Fun]
\definemathfunction[N]
\definemathfunction[Im]
\definemathfunction[Ker]
\definemathfunction[Mor]
\definemathfunction[id]
...
\definemathfunction[sSet][style=\mathbf]
\definemathfunction[Ab][style=\mathbf]
\definemathfunction[Grp][style=\mathbf]
\definemathfunction[Ring][style=\mathbf]
\definemathfunction[Vect][style=\mathbf]
\definemathfunction[Top][style=\mathbf]
\definemathfunction[Mod][stylr=\mathbf]
\definemathfunction[Comp][style=\mathbf]
\definemathfunction[pSh][style=\mathbf]
\definemathfunction[Sh][style=\mathbf]
...
\definemathsymbol[Pi][operator]["220F]
\definemathsymbol[vtc][relation]["22A5]